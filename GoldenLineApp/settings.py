"""
Django settings for GoldenLineApp project.
...
ROOT_URLCONF = 'GoldenLineApp.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "GoldenLineApp/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'GoldenLineApp.wsgi.application'
